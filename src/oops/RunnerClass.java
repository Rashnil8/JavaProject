...
public class RunnerClass {
	...
	public static void main(String[] args) {
		...
		/*
		 * Employee emp1 = new Employee(); emp1.Name = "Swapnil"; emp1.EmpId = 1281;
		 * emp1.DisplayName();
		 * 
		 * Employee emp2 = new Employee(); emp2.Name = "Rashnil"; emp2.EmpId = 8888;
		 * emp2.DisplayName();
		 * 
		 * Employee emp3 = new Employee("Prem", 7612); emp3.DisplayName();
		 * 
		...
		Citizen ct2 = new Citizen("Bhaiya", "India", 88, 4567);
		ct2.Print();
